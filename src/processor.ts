...
X2y2Processor.bind('0xB329e39Ebefd16f40d38f07643652cE17Ca5Bac1').startBlock(
  14201940
)
X2y2Processor.onBlock(async function (_, ctx: X2y2Context) {
...
ERC20Processor.bind('0x1e4ede388cbc9f4b5c79681b7f94d36a11abebc9').startBlock(
  14201940
)
export const filter = ERC20Processor.contract.filters.Transfer(
  '0x0000000000000000000000000000000000000000',
  '0xb329e39ebefd16f40d38f07643652ce17ca5bac1'
)
ERC20Processor.onTransfer(
  handleTransfer,
